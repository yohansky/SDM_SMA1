...
{{-- Modal Input Data --}}
<div class="modal fade" id="inputAgamaModal" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content">
        <div class="modal-body p-0">
          <div class="card card-plain">
            <div class="card-header pb-0 text-left">
              <h3 class="font-weight-bolder">Input Data Agama</h3>
            </div>
            <div class="card-body">
              <form role="form text-left" action="{{ route("agama.store") }}" method="post">
                @csrf
                @method("POST")
                <label>Nama Agama</label>
                <div class="input-group mb-3">
                  <input name="name" type="text" class="form-control" placeholder="Nama Agama" required>
                </div>
