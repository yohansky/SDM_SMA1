          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Data Store Mutasi</h6>
                <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#inputMutasiModal"><i class="fa-solid fa-circle-plus"></i> Tambah Mutasi</button>
                <a class="btn bg-gradient-success" href="{{ route('surat.mutasi', "masuk") }}"><i class="fa-solid fa-circle-plus"></i> Download Laporan</a>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-sm">
                        <div class="col text-center">
                          ...
                          <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editMutasiModal" data-remote="{{ route("Mutasi.edit", $m->id) }}" data-title="Update Jabatan {{ $m->id }}"><i class="fa-solid fa-user-check"></i></button>
