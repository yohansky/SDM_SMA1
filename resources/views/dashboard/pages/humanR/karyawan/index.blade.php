          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Data Store Karyawan</h6>
                <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#inputKaryawanModal"><i class="fa-solid fa-circle-plus"></i> Tambah Karyawan</button>
              </div>
            </div>
              ...
              <table class="table align-items-center" id="table-jabatan">
                <thead>
                  <tr>
                    ...
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Masa Kerja</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">
                            @php
                                $date = new DateTime($k->mulai_kerja);
                                $now = $date->diff(new DateTime("today"));
                                
                            @endphp
                            {{ $now->y. " Tahun " . $now->m ." Bulan ". $now->d. " Hari "  }}
                          </h6>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-sm">
                        <div class="col text-center">
                          ...
                          {{-- @if ($k->status == "Aktif")
                          <button type="button" class="btn bg-gradient-warning" data-bs-toggle="modal" data-bs-target="#modal-notification" id="open-deletemodal" data-id="{{ $k->NIK }}"><i class="fa-solid fa-up-from-line"></i></button>
                          @elseif($k->status == "Non-Aktif")
                          <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#modal-notification" id="open-deletemodal" data-id="{{ $k->NIK }}"><i class="fa-solid fa-up-from-line"></i></button>
                          @endif --}}
                        </div>
                      </td>
                    </tr>
