              ...
              <table class="table align-items-center" id="table-jabatan">
                <thead>
                  <tr>
                    ...
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Masuk</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                ...
                <tbody>
                  ...
                  @forelse ($karyawan as $k)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $k->Absensi()->where("status", "Masuk")->count() }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $k->Absensi()->where("status", "Izin")->count() }}</h6>
                        </div>
                      </td>
