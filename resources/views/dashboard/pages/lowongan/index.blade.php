                ...
                <tbody>
                  @forelse ($lowongan as $l)
                    <tr>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $l->id }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $l->jabatan }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $l->status }}</h6>
                        </div>
                      </td>
                      <td class="align-middle text-sm">
                        <div class="col text-center">
                          ...
                          <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editLowonganModal" data-remote="{{ route("lowongan.edit", $l->id) }}" data-title="Update Jabatan {{ $l->id }}"><i class="fa-solid fa-pencil"></i></button>
